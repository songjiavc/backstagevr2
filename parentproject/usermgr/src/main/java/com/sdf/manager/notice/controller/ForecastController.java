	 ...
	 */
	 ...
	 @RequestMapping(value = "/saveOrUpdate", method = RequestMethod.GET)
		public @ResponseBody ResultBean saveOrUpdate(
				...
				@RequestParam(value="endTime",required=false) Date endTime,//应用的默认单价
				ModelMap model,HttpSession httpSession) throws Exception
		{
...
//			   forecastMessage.setForecastName(forecastName);
			   ...
			   forecastMessage.setStartTime(DateUtil.formatDateToTimestamp(startTime, DateUtil.FULL_DATE_FORMAT));
			   forecastMessage.setEndTime(DateUtil.formatDateToTimestamp(endTime, DateUtil.FULL_DATE_FORMAT));
