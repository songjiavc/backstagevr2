...
//				"   AND u.NOTICE_ENDTIME>=CURDATE() AND u.NOTICE_STARTTIME<=CURDATE() "
	...
	public List<Fast3SiMa> getInitSimaList(int siMaId, String provinceNumber) {
		...
		String execSql = "SELECT ID*DROWN_CYCLE AS ID,YUCE_ISSUE_START,YUCE_ISSUE_STOP,DROWN_PLAN,DROWN_ISSUE_NUMBER,DROWN_NUMBER,DROWN_CYCLE,STATUS,DROWN_CYCLE,CREATE_TIME FROM "+tableName + where;
		Object[] queryParams = new Object[]{
		};
