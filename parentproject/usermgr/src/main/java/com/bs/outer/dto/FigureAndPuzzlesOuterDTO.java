...
public class FigureAndPuzzlesOuterDTO 
{
	private String id;
	...
	private List<FigureAPuzzleUploadfile> wordimgs;
	...
	public List<FigureAPuzzleUploadfile> getWordimgs() {
		return wordimgs;
	}


	public void setWordimgs(List<FigureAPuzzleUploadfile> wordimgs) {
		this.wordimgs = wordimgs;
	}
