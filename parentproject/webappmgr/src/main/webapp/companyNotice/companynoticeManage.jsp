...
<head>
    ...
    <script src="<%=request.getContextPath() %>/companyNotice/js/companynoticeManage.js" type="text/javascript"></script>
...
<body class="easyui-layout">
	...
	<div   data-options="region:'north'" style="height:90px;border:1px solid #95b8e7; background-color:white;">
	    	<table style="border: none;height: 80px;">
		    	<tr>
		    		<td width="7%" class="td_font">公司公告名称：</td>
		    		<td width="15%">
		    			<input id="comnoticeNameC" class="input_border"  type="text" name="comnoticeNameC"  />  
		    		</td>
		    	...
		    	<tr>
		    		...
		    		<td width="7%" class="td_font">公司公告状态：</td>
		    		<td width="15%">
		    			<select class="easyui-combobox" id="comnoticeStatusC" name="comnoticeStatusC" style="width:100px;">
								<option value="">全部</option>
    ...
    <div  data-options="region:'center'" data-options="border:false" >
    	 <table id="datagrid" class="easyui-datagrid"  title="公司公告列表" >
			</table>
 	</div>  
  
  
    <!-- 添加公司公告弹框 -->
  <div id="addComnotice" class="easyui-dialog" data-options="modal:true" fit="true" title="添加公司公告" style="width:800px;height:600px;padding:0px;border:0;top:1px;"
            data-options="
                iconCls: 'icon-save',
                buttons: [{
                    text:'保存',
                    iconCls:'icon-ok',
                    handler:function(){
                        submitAddComnotice('0');
                    }
                },{
                    text:'发布',
                    iconCls:'icon-ok',
                    handler:function(){
                        submitAddComnotice('1');
                    }
                },{
                    text:'取消',
                    iconCls:'icon-cancel',
			...
			<div class="easyui-layout" style="height:100%;padding:0;" >
	    	 	<div region="north" style="height:40%;" title="公司公告基本内容" hide="false" >
	    	 		<form id="ff" method="get"  style="margin-top:5px;" ><!-- enctype="multipart/form-data":上传文件需要,这是提交媒体文件的声明 -->
		    	 		<div class="ftitle">
				            <label for="codeA">公司公告名称:</label>
				            <input type="hidden" name="id" id="idA"/>
				            <input class="easyui-validatebox commonInput" type="text" id="comnoticeNameA" name="comnoticeName" style="width:200px"  
	    	 	...
	    	 	<div region="center" style="height:60%;padding:0;" >
	    	 		<div id="txzDivA" style="width:100%;height:50%;">
	    	 			<table id="stationDataGridA" class="easyui-datagrid" style="width:100%;height:100%;" title="选择发布公司公告的通行证组" ></table>
	    	 		</div>
     ...
     <!-- 修改公司公告弹框 -->
     <div id="updateComnotice" class="easyui-dialog" data-options="modal:true" fit="true" title="修改公司公告信息" style="width:800px;height:600px;padding:0px;border:0;top:1px;"
            data-options="
                iconCls: 'icon-save',
                buttons: [{
                    text:'保存',
                    iconCls:'icon-ok',
                    handler:function(){
                        submitUpdateComnotice('0');
                    }
                },{
                    text:'发布',
                    iconCls:'icon-ok',
                    handler:function(){
                        submitUpdateComnotice('1');
                    }
                },{
                    text:'取消',
                    iconCls:'icon-cancel',
	    ...
	    <div class="easyui-layout" style="height:100%;padding:0;" >
	    	 	...
	    	 	<div region="center" style="height:60%;padding:0;" >
	    	 		<div id="txzDivA" style="width:100%;height:50%;">
	    	 			<table id="stationDataGridU" class="easyui-datagrid" style="width:100%;height:100%;" title="选择发布公司公告的通行证组" ></table>
	    	 		</div>
	    	 		<div style="width:100%;height:50%;">
     ...
     <!-- 查看详情公司公告弹框 -->
     <div id="detailComnotice" class="easyui-dialog" data-options="modal:true" fit="true" title="查看公司公告信息详情" style="width:800px;height:600px;padding:0px;border:0;top:1px;"
            data-options="
                iconCls: 'icon-save',
                buttons: [{
                    text:'取消',
	    ...
	    <div class="easyui-layout" style="height:100%;padding:0;" >
	    	 	<div region="north" style="height:40%;" title="公司公告基本内容" hide="false">
	    	 		<form id="ffDetail" method="get" novalidate style="margin-top:5px;">
		    	 		<div class="ftitle"> 
				            ...
				            <input class="easyui-validatebox commonInput" type="text" id="comnoticeNameD" name="comnoticeName" style="width:200px"  
				        ...
				        <div class="ftitlenot">
				            <label for="priceA">公司公告内容:</label>
				            <textarea id="comnoticeContentU" name="comnoticeContent" class="easyui-validatebox" 
	    	 	...
	    	 	<div region="center" style="height:60%;padding:0;" >
	    	 		<div id="txzDivD" style="width:100%;height:50%;">
	    	 			<table id="stationDataGridD" class="easyui-datagrid" style="width:100%;height:100%;" title="选择发布公司公告的通行证组" ></table>
	    	 		</div>
	    	 		<div style="width:100%;height:50%;">
