...
<body class="easyui-layout">
    ...
    <!-- 添加公司公告弹框 -->
  <div id="addComnotice" class="easyui-dialog" title="添加公司公告" style="width:800px;height:650px;padding:0px;border:0;"
            data-options="
                iconCls: 'icon-save',
                buttons: [{
                    text:'保存',
     ...
     <!-- 修改公司公告弹框 -->
     <div id="updateComnotice" class="easyui-dialog" title="修改公司公告信息" style="width:800px;height:600px;padding:0px;border:0;"
            data-options="
                iconCls: 'icon-save',
                buttons: [{
                    text:'保存',
